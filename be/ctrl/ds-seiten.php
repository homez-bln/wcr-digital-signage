 ...
 * Gruppen-Sortierung + Portrait 9:16 iFrame
 */
...
<head>
  ...
  <style>
    ...
    .ds-card.is-portrait { max-width: 320px; }
    ...
    .ds-frame-wrap iframe { display:block; position:absolute; top:0; left:0; border:none; opacity:0; transition:opacity .4s; pointer-events:none; transform-origin:top left; }
    .ds-frame-wrap iframe.loaded { opacity:1; }
    .ds-frame-wrap.landscape iframe { width:1920px; height:1080px; }
    .ds-frame-wrap.portrait  iframe { width:1080px; height:1920px; }
...
function dsScale() {
    document.querySelectorAll('.ds-frame-wrap').forEach(function(wrap) {
        ...
        var nW = portrait ? 1080 : 1920;
        var nH = portrait ? 1920 : 1080;
